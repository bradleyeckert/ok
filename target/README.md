...
The [com0com](https://sourceforge.net/projects/com0com/) Null-modem emulator allows you to run `ok` and `targ` in different terminals on the same PC. On Linux, something like `socat PTY,link=/dev/ttyS14 PTY,link=/dev/ttyS15` should work.
